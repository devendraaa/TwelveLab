  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          <div className="border border-white/10 rounded-2xl p-8 bg-white/2 text-center">
            <div className="text-5xl mb-4">✉️</div>
            <p className="text-[#6b6860] text-sm mb-6">
              If <span className="text-white">{email}</span> is registered, you&apos;ll receive a password reset link.
            </p>
            <Link href="/login" className="text-xs text-[#c8f060] hover:text-white transition-colors">
